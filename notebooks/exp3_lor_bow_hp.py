...
mlflow.set_tracking_uri('https://dagshub.com/amit5631/mlops-mini-project.mlflow')
dagshub.init(repo_owner='amit5631', repo_name='mlops-mini-project', mlflow=True)
...
with mlflow.start_run():
    ...
    # Calculate best accuracy using the best model
